...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 18 sep. 2023 à 21:21
...
CREATE TABLE `agents` (
  ...
  `date_de_naissance` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `nationalite` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `specialites` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
...
INSERT INTO `agents` (`id_agent`, `nom`, `prenom`, `date_de_naissance`, `nationalite`, `specialites`) VALUES
(1, 'MARCK', 'OTTO', '11/09/2000', 'SUISSE', 'SECURITE'),
(2, 'JACOB', 'GALLO', '23/11/2023', 'BELGE', 'TUEUR'),
(3, 'LARY', 'BRID', '05/08/1994', 'AMERICAIN', 'RENSEIGNEMNT'),
(4, 'JON', 'CASTELLO', '22/01/1987', 'USA', 'DETECTIVE'),
(5, 'JPRDAN', 'JOE', '23/12/1985', 'PORTUGUAIS', ''),
(6, 'PIERRE', 'DIOP', '23/11/2000', 'GRECQUE', 'BANDIT');
...
INSERT INTO `cibles` (`id_cibles`, `nom`, `prenom`, `date_de_naissance`, `nationalite`) VALUES
(1, 'MARIA ', 'BETON', '28', 'ITALIENNE'),
(2, 'JEAN LUIZ', 'NELSON', '20', 'TURQUE'),
(3, 'RUDY', 'TOP', '8', 'MAROCAIN'),
(4, 'HENRI ', 'CLAUDE', '12', 'CHINOIS'),
(5, 'AICHA', 'DAMM', '23', 'CANADIENNE'),
(6, 'LAURA', 'CELTA', '34', 'PORTUGUAISE');
...
INSERT INTO `contacts` (`id_contact`, `nom`, `prenom`, `nationalite`, `date_de_naissance`) VALUES
(1, 'JEAN ', 'EVRA', 'SENEGALAISE', '12/05/1999'),
(2, 'BATISTE', 'pierre', 'GRECQUE', '02/10/1989'),
(3, 'LAMINE ', 'FERNANDEZ', 'ESPAGNOL', '07/09/1982'),
(4, 'MICAEL ', 'JACKSON', 'USA', '12/03/1991');
...
CREATE TABLE `missions` (
  ...
  `agents` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `contacts` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cibles` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `planques` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `specialite` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_debut` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `date_fin` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `missions` (`id`, `titre`, `pays`, `agents`, `contacts`, `cibles`, `descript`, `statut`, `planques`, `specialite`, `date_debut`, `date_fin`) VALUES
(1, 'operation ', 'belgique', 'jacob', 'belgique', 'president', ' le suivre chaque deplacemnt', 'encours', 'appartement ', 'tueur', '22/12/2020', '12/01/2021'),
(4, 'mission', 'belgique', 'jacob', 'belgique', '', 'tueur', 'en_cours', 'maison', 'protection', '2023-06-30', '2023-07-01'),
(5, 'FNN', '??', '??', '?B ', '', '  NNGB', 'en_cours', 'BNNN', 'NN', '2023-06-29', '2023-07-01'),
(7, 'k:', 'oo', 'll', 'o', '', 'azer', 'en_cours', 'lll', 'l', '2023-06-29', '2023-07-01'),
(8, 'k:', 'oo', 'll', 'o', '', 'azer', 'en_cours', 'lll', 'l', '2023-06-29', '2023-07-01'),
(9, 'k:', 'oo', 'll', 'o', '', 'azer', 'en_cours', 'lll', 'l', '2023-06-29', '2023-07-01'),
(10, 'k:', 'oo', 'll', 'o', '', 'azer', 'en_cours', 'lll', 'l', '2023-06-29', '2023-07-01'),
(11, 'k:', 'oo', 'll', 'o', '', 'azer', 'en_cours', 'lll', 'l', '2023-06-29', '2023-07-01'),
(12, 'k:', 'oo', 'll', 'o', '', 'azer', 'en_cours', 'lll', 'l', '2023-06-29', '2023-07-01'),
(13, 'k:', 'oo', 'll', 'o', '', 'azer', 'en_cours', 'lll', 'l', '2023-06-29', '2023-07-01'),
(14, 'mission', 'espagne', 'jean', 'espagne', '', 'bonjour je suis ala recherche de garde du corps ', 'en_cours', 'voiture', 'securite', '2023-06-29', '2023-07-07'),
(15, 'mission', 'espagne', 'MARCK OTTO', 'legal', '', 'ccc', 'en_cours', 'MARKEQUE', 'protection', '2023-07-05', '2023-07-07');
...
INSERT INTO `planques` (`id_planque`, `adresse`, `pays`, `type`) VALUES
(1, 'MARKEQUE', 'CANADA', 'DEHORS'),
(2, 'MELLIA ', 'ESPAGNE', 'VOITURE'),
(3, 'FLORIDE', 'MIAMI', 'APPARTEMENT'),
(4, 'PARIS', 'FRANCE', 'SOLEIL'),
(5, 'LYON', 'FRANCE', 'CACHO'),
(6, 'ATHENES', 'GRECES', 'MONTAGNE');
...
CREATE TABLE `user` (
  ...
  `mdp` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'bambafepp1@outlook.fr', '52036e5a96b401419e3b870bb3859828b111afd2'),
(4, 'soda@email.fr', '1122');
...
--
ALTER TABLE `cibles`
  MODIFY `id_cibles` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `planques`
  MODIFY `id_planque` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
